...
## Decision
We record each significant architectural decision as a short ADR in `docs/adr/`, numbered
sequentially. Each ADR states context, the decision, and consequences.
